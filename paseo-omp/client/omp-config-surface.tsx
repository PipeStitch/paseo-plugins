      ...
      {settings.map((setting) => {
        ...
        return (
          <View key={setting.path} style={styles.setting}>
            <View style={styles.settingHeader}>
              ...
              {setting.workspaceOverride ? (
                <Text style={styles.source}>
                  {setting.workspaceOverrideSource === "legacy"
                    ? "Legacy workspace override"
                    : setting.workspaceOverrideSource === "both"
                      ? "Workspace override · also in legacy settings"
                      : "Workspace override"}
                </Text>
              ) : null}
              {!complex && !editable ? (
            ...
            setting.workspaceOverrideSource === "both" ? (
              <Text style={styles.muted}>
                Remove the legacy value from .omp/settings.json before resetting this override.
              </Text>
            ) : null}
            ...
            {editable ? (
              <EditableScalarValue
                ...
                showReset={!workspaceScoped || setting.workspaceOverrideSource === "config"}
                styles={styles}
